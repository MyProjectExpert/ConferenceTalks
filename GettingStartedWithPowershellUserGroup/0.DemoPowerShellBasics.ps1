...
#$URL = "http://MyProjectExpert.wcc2prod.local"
#Start-Process "C:\Program Files\Internet Explorer\iexplore.exe" -ArgumentList $URL
#Start-Process "C:\Program Files\Internet Explorer\iexplore.exe" -ArgumentList $URL -Credential "wcc2prod\mawharton"
##
#$URL = "http://wcc2013sp.wcc2prod.local"
#$username = "wcc2prod\mwharton"
#$admin    = "wcc2prod\mawharton"
...
Get-Service -Name *SQL* -ComputerName "WCC2MSI2"
...
Test-Connection WCC2MSI2, BING.COM

Test-Connection LABA-2013SP, LABA-2012SQL
Test-Connection LABA-2013SP, LABA-2012SQL -Source 192.168.1.22
Test-Connection LABA-2013SP, LABA-2012SQL -Source WCC2013SP -Credential wcc2prod\mawharton
...
$ie.Visible = $true
$ie.Navigate($url)
$ie.Document.getElementByID("txtUserName").value = "mwharton@whartoncomputer.com"
$ie.Document.getElementByID("txtPassword").value = "Wharwhar#99"
$ie.Document.getElementByID("lbLogin").click();
