...
#Start-Process "C:\Program Files\Internet Explorer\iexplore.exe" -ArgumentList $URL -Credential "domainName\mawharton"
##
#$URL = "http://wcc2013sp.domainName.local"
#$username = "domainName\mwharton"
#$admin    = "domainName\mawharton"
...
Test-Connection LABA-2013SP, LABA-2012SQL -Source WCC2013SP -Credential domainName\mawharton
