...
#
Get-NetFirewallRule remote* -CimSession WCC2MSI2  |
...
#   Run a script block
Invoke-Command -ScriptBlock {Get-Process -IncludeUserName} -ComputerName Wcc001VS -Credential domain\mwharton
...
Test-WSMan -ComputerName WCC001VS
Test-WSMan -ComputerName WCC001VS -Credential domain\username  # fails 
Test-WSMan -ComputerName WCC001VS -Credential domain\username -Authentication Default
#
